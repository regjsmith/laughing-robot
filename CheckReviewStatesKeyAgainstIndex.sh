...
do
	...
	do
        ...
        # If review key state is different from the state stored in the index, generate commands to fix hte index	
...
# Everthing below is left for reference and future improvements to check pending inconsistencies in the 
# index that cause reviews to show in both the open and close tabs of the reviews page
